...
4) requirements met: 
	...
	10: data saved between executions: see dbconnection.cpp/.h as well as sql and php folders in tar file. all changes will be saed and retrieved from online database
